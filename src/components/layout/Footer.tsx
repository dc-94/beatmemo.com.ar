              ...
              <div>
                ...
                <p className="text-brand-white-200 font-sans text-sm">
                  Rosario, Santa Fe, Argentina
                              ...
                              {horarios.length > 0 && (
                <div className="mt-6">
                  <h4 className="text-brand-white-100 font-sans font-bold tracking-widest uppercase mb-2 text-xs">
                    Horarios
                  </h4>
                  <ul className="space-y-1">
                    {horarios.map((h, i) => (
                      <li key={i} className="text-brand-white-200 font-sans text-sm flex justify-between gap-4 max-w-xs">
                        <span>{h.dias}</span>
                        <span className="text-brand-gold whitespace-nowrap">{h.horario}</span>
                      </li>
                    ))}
                  </ul>
                </div>
